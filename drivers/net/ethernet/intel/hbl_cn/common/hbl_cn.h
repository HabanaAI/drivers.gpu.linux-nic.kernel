...
extern const struct hbl_cn_stat hbl_cn_mac_fec_stats[];
extern const struct hbl_cn_stat hbl_cn_mac_stats_rx[];
extern const struct hbl_cn_stat hbl_cn_mac_stats_tx[];
extern const size_t hbl_cn_mac_fec_stats_len;
extern const size_t hbl_cn_mac_stats_rx_len;
extern const size_t hbl_cn_mac_stats_tx_len;
